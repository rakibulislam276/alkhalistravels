...
window.AlKhalis.Data = {
  ...
  /* ── BLOG POSTS ───────────────────────────────────────────── */
  blogPosts: [
    { emoji:'🕋', img:'assets/images/blog-umrah.jpg', cat:'Hajj & Umrah', catType:'blue',   url:'blog/umrah-guide-2025.html', date:'April 28, 2025', read:'8 min', author:'Al Khalis Team', title:'Complete Umrah Guide 2025: Everything You Need to Know Before Your Pilgrimage',         excerpt:'A comprehensive guide covering visa requirements, packing essentials, spiritual rituals, hotel recommendations and practical tips for first-time Umrah pilgrims.', tags:['Umrah','Saudi Arabia','Pilgrimage Guide'], featured:true },
    { emoji:'🏙', img:'assets/images/blog-dubai.jpg', cat:'Destination',  catType:'gold',   url:'blog/dubai-budget-guide.html', date:'April 20, 2025', read:'5 min', author:'Ahmed Shaikh',   title:'Top 10 Things to Do in Dubai on a Budget — Mumbai Traveller\'s Guide',                  excerpt:'Dubai doesn\'t have to break the bank. From free beaches and iconic architecture to budget dining and souks — experience Dubai affordably from Mumbai.', tags:['Dubai','Budget Travel','UAE'], featured:false },
    { emoji:'📋', img:'assets/images/blog-visa.jpg', cat:'Visa News',    catType:'blue',   url:'blog/schengen-visa-2025.html', date:'April 15, 2025', read:'4 min', author:'Fatima Ansari',  title:'Schengen Visa from India in 2025: New Requirements, Processing Times & Tips',             excerpt:'Europe visa rules have changed significantly. Here\'s everything Indian travellers need to know about the updated Schengen requirements and digital application process.', tags:['Schengen','Europe Visa','2025'], featured:false },
    { emoji:'🌴', img:'assets/images/blog-family.jpg', url:'blog/family-destinations.html', cat:'Packages',     catType:'gold',   date:'April 8, 2025',  read:'6 min', author:'Mohammed Khalis',title:'Best Family Holiday Destinations from Mumbai in 2025 — With Prices & Packages',          excerpt:'Planning a family trip this year? We\'ve rounded up the best destinations reachable from Mumbai with complete package pricing and travel tips.', tags:['Family Travel','Mumbai','Packages'], featured:false },
    { emoji:'💱', img:'assets/images/blog-forex.jpg', url:'blog/forex-tips.html', cat:'Forex',        catType:'gold',   date:'March 30, 2025', read:'3 min', author:'Al Khalis Team', title:'When to Exchange Currency for Your Trip: Smart Forex Tips for Indian Travellers',       excerpt:'Getting the best exchange rate can save thousands. Here\'s our expert guide on when, where, and how much currency to exchange before your international trip.', tags:['Forex','Currency','Money Tips'], featured:false },
  ],
