...
window.AlKhalis.Data = {
  ...
  /* ── BLOG POSTS ───────────────────────────────────────────── */
  blogPosts: [
    { emoji:'🕋', cat:'Hajj & Umrah', catType:'blue',   date:'April 28, 2025', read:'8 min', author:'Al Khalis Team', title:'Complete Umrah Guide 2025: Everything You Need to Know Before Your Pilgrimage',         excerpt:'A comprehensive guide covering visa requirements, packing essentials, spiritual rituals, hotel recommendations and practical tips for first-time Umrah pilgrims.', tags:['Umrah','Saudi Arabia','Pilgrimage Guide'], featured:true },
    { emoji:'🏙', cat:'Destination',  catType:'gold',   date:'April 20, 2025', read:'5 min', author:'Ahmed Shaikh',   title:'Top 10 Things to Do in Dubai on a Budget — Mumbai Traveller\'s Guide',                  excerpt:'Dubai doesn\'t have to break the bank. From free beaches and iconic architecture to budget dining and souks — experience Dubai affordably from Mumbai.', tags:['Dubai','Budget Travel','UAE'], featured:false },
    { emoji:'📋', cat:'Visa News',    catType:'blue',   date:'April 15, 2025', read:'4 min', author:'Fatima Ansari',  title:'Schengen Visa from India in 2025: New Requirements, Processing Times & Tips',             excerpt:'Europe visa rules have changed significantly. Here\'s everything Indian travellers need to know about the updated Schengen requirements and digital application process.', tags:['Schengen','Europe Visa','2025'], featured:false },
